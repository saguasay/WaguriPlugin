(function() {
    ...
    return {
        onLoad: function() {
            ...
            patches.push(vendetta.patcher.instead("sendMessage", MessageActions, function(args, orig) {
                var message = args[1];
                if (typeof message?.content === "string" && message.content.trim().toLowerCase() === "waguri") {
                    var randomGif = gifs[Math.floor(Math.random() * gifs.length)];
                    return orig.call(this, args[0], Object.assign({}, message, { content: randomGif }));
                }
